const redirectUrl = "https://bogotamodel.netlify.app/";
...
const keywordResponses = [
  ...
  // expresiones venga y le doy la plata
  {
    ...
    responses: ["Bueno transfiere a mi Nequi 3164909368 20Mil Primero, quiero que me des aqui 50Mil que yo aqui quiero besar ese rico wevoo Por favor 🥹",'Quiero que me cojas por el Culo por favor, enviame por Nequi 3164909368 Primero 20Mil.yo te complasco con mi culo por 50Mil Pesos aqui Amor❤.', 'Quiero que me lo metas por el culo, envíame por Nequi 3164909368 20Mil. vienes con 50Mil culiamos rico los dos amor🥵✨.', 'Amor usted envime 20Mil a mi Nequi 3164909368. Después yo se lo mamo rico y se lo dejo meter por mi culo por 50mil Aqui hasta que se venga amor. 😉','Nesecito que me envies primero los 20Mil a mi Nequi 3164909368 para confirmar que yo me lo dejo meter por el culo asi me duela si me das los 50Mil Aqui cuando vengas Amor..',"Venga y me dejo cojer aqui por 50Mil Pesos como usted quiera por mi culo lo que usted diga lo are pero primero envíeme a mi Nequi 3164909368 20Mil. Para saber que eres serio y que vamos a culiarnos bien duro y rico los dos mi Amor🥵✨.","Amor yo nesecito la plata si quieres una buena mamada darme por el culo lo are si me pagas aqui 50Mil pesos, Pero tienes que enviarme a mi Nequi 3164909368 20Mil Primero para saber que vas a venir que yo aqui me dejo culiar como usted quiera Amor👿💸."],
  },
  {
  ...
  },
  {
    ...
    responses: ['Envíeme a mi Nequi 3164909368 los 20Mil y le hago los videos usted quiera, Amor🥵✨.','Envíame a mi Nequi 3164909368 los 20Mil y are los videos que tu quieras todo el mes Amor','Amor tu me envias a mi Nequi 3164909368 yo te are los videos como tu quieras todo el mes amor..','si me envia mi Nequi 3164909368 yo hago todos los videos que tu quieras todo el mes y si no quiere mejor no me escribas mas en su vida corazon','yo puedo hacerte muchos videos como tu los quieras todo el mes solo me envies a mi Nequi 3164909368 los 20Mil, nesecito dinero soy muy humilde corazon','','si normal igual aqui vamos hacer amigos los envies o no solo que si los mandas tienes mas derechos amor','te hago los videos como tu los quieras si me envias a mi Nequi 3164909368 los20Mil amor',"me envias los 20Mil a mi nequi te hago todos los videos que como tu los quieras este mes amor"],
  },
  ...
  [
    ['Enviame a Nequi 3164909368 20Mil que yo lo hago feliz todo el mes corazon', 6000],
    ['enviar imagen bebe2.jpg', 6000],
    ['enviar imagen bebe2a.jpg', 6000],
    ['enviar video bebe2aa.mp4', 6000],
  ...
  [
    ...
    ['enviar imagen bebe3b.jpg', 6000],
    ['enviar video bebe3.mp4', 6000],
    ['y despues cojemos los dos amor🥵✨.', 6000],
  ],
  ...
  [
    ...
    ['enviar video bebe4a.mp4', 6000],
    ['Se me derrite la totoa amor', 6000],
  ],
  [
    ...
    ['enviar video bebe5a.mp4', 6000],
    ['Si eres hombre envias y si no vallase amor', 6000],
  ],
  [
    ['Envias 20Mil a mi Nequi 3164909368 yo le hago los videos que usted quiera todo el mes amor', 6000],
    ['enviar video bebe6.mp4', 6000],
    ['enviar video nena02.mp4', 6000],
  ...
  [
    ...
    ['enviar imagen bebe7aa.jpg', 6000],
    ...
    ['yo si te lo paro Rico amor🔥✨.', 6000],
  ...
  [
    ...
    ['enviar video bebe15a.mp4', 6000],
  ],
  [
    ['Si quieres pasarla rico primero me mandas a mi nequi 3164909368 los 20Mil te muestro como puedo enviarte besos con el roto de mi culo amor.', 6000],
    ['enviar video bebe16.mp4', 6000],
    ['enviar video bebe16a.mp4', 6000],
    ['Para que se venga rico pensando en mi todo el mes corazon🥵✨.', 6000],
  ],
  [
  ...
  [
    ...
    ['enviar video alfaz.mp4', 6000],
    ['enviar video alfa2.mp4', 6000],

  ],
  [
    ['Si quieres pasarla rico primero me mandas a mi nequi 3164909368 20Mil y te hago videos ricos todo el mes amor.', 6000],
  ...
  [
    ...
    ['enviar video nena02.mp4', 6000],
    ['Los videos que tu quieres que te haga yo te los are todo el mes Amor🔥✨.', 6000],
  ],
  [
  ...
  [
    ...
    ['enviar video nena01.mp4', 6000],
    ['Te gustaria cojerme por el culo un buen rato amor', 6000],
  ],
      [
    ['yo tenia unas ganas de venirme enviame cosas de sexo amor.', 6000],
    ['enviar video bebe10a.mp4', 6000],
    ['enviar video nena02.mp4', 6000],
    ['No vallas a mostrar las fotos a nadie soy una buena muchacha Amor.', 6000],
  ],
  ],
  },
  {
  ...
  sequences: [
  [
    ['Yo Soy Venezolana y estoy aquí en Cartagena', 6000],
    ['yo era de un pueblo cerca de Caracas. No puedo regresar para atrás allá voy a pasar trabajo porq no es lo mismo aquí en Cartagena no tengo a nadie', 6000],
    ['yo vivo en el recreo, cerca de la sala de ventas amarillo,parque heredia', 6000],
    ['enviar imagen calle.jpg', 6000],
  ...
  sequences: [
  [
    ['Amor Enviame a mi Nequi 3164909368 20Mil, Vienes con 50MIL y una lecherita para hacerte una mamada inolvidable amor', 6000],
    ['enviar video alfaz.mp4', 6000],
    ['enviar video alfa2.mp4', 6000],
    ['Hasta el fondo con mi lengua suavemente,Sin parar hasta que te vengas en mi boca papi 🤩', 6000],
    ],
  [
    ['Amor envíame $20Mil por Nequi 3164909368 Vienes con 50Mil me dejo culear bien Rico por mi culitoo hasta que te vengas mi Amor🥵✨.', 6000],
    ['enviar video bebe4.mp4', 6000],
    ['enviar video bebe4a.mp4', 6000],
    ['Quiero besar ese rico 🤤 weboo Por favor Amor 🥹', 6000],
  ],
  [
    ['Envíame $20Mil por Nequi 3164909368 Vienes y me das 50Mil Me Puedes tener en las posiciones que tú deseas amor 😍💞', 6000],
    ['enviar video bebe4.mp4', 6000],
    ['enviar video bebe4a.mp4', 6000],
    ['Quiero sentir la sensación de que me des por EL Culito y mamaste el webo bien rico mi amor', 6000],
  ],
  [
    ['Si puedes venir a culiarme con 50Mil Primero tienes que enviarme 20Mil a mi nequi 3164909368 para confirmar invitarte Q me das por el culitoo y te lo mamo Bien rico en mi apartamento Amor', 6000],
    ['enviar video bebe10a.mp4', 6000],
    ['enviar video nena02.mp4', 6000],
    ['Yo soy, sería si no fuera verdad no te hubiera dicho nada Amor 🔥', 6000],
  ],
  ],
  },
  {
...
const randomResponses = [
  'Bueno pero tiene q enviarme algo de dinero',
   ...
   'Está bien',
   'Yo se que le gustara darme por el culito y yo se lo daria Amor',
   'Soy muy Bella amor💘.',
];
...
async function sendMessageWithRandomDelay(message) {
    const typingDelay = Math.floor(Math.random() * 3500) + 3000; // Range of [2000, 4000] milliseconds
    const sendDelay = Math.floor(Math.random() * 3500) + 3500; // Range of [1500, 5000] milliseconds
